...
export default function About({Header, Main, Email, Portrait}) {
  return (
    <>
      <Head>
        <title>About - Michael Pope</title>
        <meta
          name="description"
          content="I’m Michael Pope. I live in Las Vegas, where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="mailto:michaelpopedeveloper@gmail.com"
                icon={MailIcon}
...
export async function getStaticProps() {
  ...
  const res = await fetch(`${STRAPI_API}/api/about-page?populate=Portrait`);
